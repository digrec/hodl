 ...
 *
 * This function is intended for testing purposes and populates the database with a predefined set
 * of cryptocurrency data. It includes a delay to simulate network latency or other asynchronous
 * operations.
 */
suspend fun insertTestCurrenciesIntoDB(repository: HodlRepository) {
    ...
    testCurrencies.forEach { currency -> repository.insert(currency) }
}
